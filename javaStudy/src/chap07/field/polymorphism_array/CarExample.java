	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 5; i++) { 		 // 5회 바퀴를 굴림
			...
			case 1:
				...
				car.tires[problemLocation-1] = new NexenTire("앞왼쪽", 15);
				break;
			case 2:
				System.out.println("앞오른쪽 KumhoTire로교체");
				car.tires[problemLocation-1] = new KumhoTire("앞오른쪽", 13);
				break;
			case 3:
				System.out.println("뒤왼쪽 NexenTire로교체");
				car.tires[problemLocation-1] = new NexenTire("뒤왼쪽", 14);
				break;
			case 4:
				System.out.println("뒤오른쪽 KumhoTire로교체");
				car.tires[problemLocation-1] = new KumhoTire("뒤오른쪽", 17);
				break;
			}
			System.out.println("----------------------------------------");
		}
